...
// // ── Modal Form ───────────────────────────────────────────────────
// function CallBackModal({ onClose, productName }) {
//     const [form, setForm] = useState(INITIAL_FORM);
//     const [errors, setErrors] = useState({});
//     const [loading, setLoading] = useState(false);
//     const [submitted, setSubmitted] = useState(false);
...
// // ── Main Component ───────────────────────────────────────────────
// export default function AdvancedDentalEquipment({ productName = "TECHNOMAC Dental Equipment" }) {
//     const [showModal, setShowModal] = useState(false);
...
//                                     Premium dental healthcare products and advanced clinic setup
//                                     solutions designed for modern dental professionals.
//                                 </p>
//                                 <button
